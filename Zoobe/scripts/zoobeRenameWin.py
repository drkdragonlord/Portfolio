...
def zoobeRenameWin():
	...
	mainTabLO = cmds.tabLayout('mainTabLO', height=(ht-2), width=(wt-2), tabsVisible=True, enableBackground=True, sc='mainWinUI.changeTabCmd()')
	...
	performBtn = cmds.button(width=(wt-210), height=(ht-80), label='Execute', command="mainWinUI.getArgsProc()")
	...
	#Children of singleForm
	browseDirField = cmds.textFieldButtonGrp('browseDirField', cw=((1, 110), (2, 290), (3, 120)), ed=0, bl='browse...', bc='mainWinUI.getScenesDir()', l='Animations Directory: ', tx='', w=(wt+200) )
	...
	multPerformBtn = cmds.button(width=(wt+185), height=(ht-80), label='Execute', command="mainWinUI.getMultiArgsProc()")
...
if __name__ == "__mainWinUI__": mainWinUI()
